...
namespace DCETRuntime
{
	public static class MonoHelper
	{
		...
		public const string AssetBundle = "Unity.DCET.AssetBundle.Hotfix";
		...
		public static string AssetBundleDll = $"{AssetBundle}.dll";
		...
		public static string AssetBundlePdb = $"{AssetBundle}.pdb";
		...
		public static string AssetBundleDllAssetBytes = $"Assets/Res/Code/{AssetBundle}.dll.bytes";
		...
		public static async void StartHotfix()
		{
			...
			if (code)
			{
				...
				Assembly.Load(GameObjectHelper.GetTextAsset(code, AssetBundleDll).bytes, GameObjectHelper.GetTextAsset(code, AssetBundlePdb).bytes);
